...
GlobalNgENB_ID_t * enc_global_ng_enb_asn(const global_ng_enb_id_t * global_ng_enb_id)
{
    ...
    case MACRO_NG_ENB_TYPE_ID:
        ...
        MACRO_NG_ENB_ID_TO_BIT_STRING(global_ng_enb_id->macro_ng_enb_id, &global_ng_enb_id_asn->ngENB_ID.choice.macroNgENB_ID);
        break;
    
    case SHORT_MACRO_NG_ENB_TYPE_ID:

        global_ng_enb_id_asn->ngENB_ID.present = NgENB_ID_PR_shortMacroNgENB_ID;
        SHORT_MACRO_NG_ENB_ID_TO_BIT_STRING(global_ng_enb_id->short_macro_ng_enb_id, &global_ng_enb_id_asn->ngENB_ID.choice.shortMacroNgENB_ID);
        break;

    case LONG_MACRO_NG_ENB_TYPE_ID:

        global_ng_enb_id_asn->ngENB_ID.present = NgENB_ID_PR_longMacroNgENB_ID;
        LONG_MACRO_NG_ENB_ID_TO_BIT_STRING(global_ng_enb_id->long_macro_ng_enb_id, &global_ng_enb_id_asn->ngENB_ID.choice.longMacroNgENB_ID);
        break;
