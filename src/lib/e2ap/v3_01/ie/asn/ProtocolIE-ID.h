...
#define ProtocolIE_ID_id_XAPP_ID	((ProtocolIE_ID_t)98)
#define ProtocolIE_ID_id_E2nodesConnected	((ProtocolIE_ID_t)99)
#define ProtocolIE_ID_id_NODEfunctionID_Item	((ProtocolIE_ID_t)100)
